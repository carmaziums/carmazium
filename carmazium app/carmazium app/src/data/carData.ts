 ...
 *
 * Ported verbatim from web's src/lib/carData.ts (mobile-production-
 * readiness-plan.md F26) — mobile previously had no make/model relationship
 * at all (both were free-text). Keep in sync with web manually; there is no

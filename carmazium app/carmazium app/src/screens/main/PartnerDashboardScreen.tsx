...
const styles = StyleSheet.create({
  ...
  linkText: { fontFamily: FontFamily.bold, color: Colors.accent, fontSize: FontSize.size11 },
  ...
  serviceStatus: { fontFamily: FontFamily.medium, color: Colors.textMuted, fontSize: FontSize.size11, marginTop: 3 },

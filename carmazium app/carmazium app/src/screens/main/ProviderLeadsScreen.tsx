...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: FontFamily.bold, color: Colors.white, fontSize: FontSize.size16 },
  ...
  emptyTitle: { fontFamily: FontFamily.bold, color: Colors.white, fontSize: FontSize.size16, marginTop: 12 },

...
| Ads conversion action | Event | Label | Type |
|---|---|---|---|
| Purchase | `purchase` | `KyfHCLLQ1eocEN6N4qNE` | Primary, value-based, count Every |
| Submit lead form (1) | `listing_submitted` | `uD94CLXQ1eocEN6N4qNE` | Primary |
...
### 2. `purchase` covers every fee type
...
### 3. `listing_submitted` fires before payment
...
### 4. Two Ads goals remain Misconfigured
...
### 5. New conversion actions show "Misconfigured" / "Needs attention"
...
### 6. A second GA4 property is collecting
...
### 8. Enhanced Conversions not implemented

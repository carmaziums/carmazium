...
Plans:
- [x] 02-01-PLAN.md — Foundation: jest config, KpiTile, LeadFunnelBar, role router
- [x] 02-02-PLAN.md — Buyer dashboard: overview + bids + offers + history screens
- [x] 02-03-PLAN.md — Seller dashboard: overview + offer inbox + earnings
- [x] 02-04-PLAN.md — Dealer dashboard: KPI tiles + lead funnel chart + trend stats
...
Plans:
- [x] 15-01-PLAN.md — Wave 0 (TDD): delivery.service.spec.ts 8 stubs + delivery-expiry.service.spec.ts 1 stub (RED state)
- [x] 15-02-PLAN.md — Wave 1: Prisma schema + full NestJS delivery module (service, controller, DTOs, expiry cron, delivery filter)
- [x] 15-03-PLAN.md — Wave 2a: deliveryApi.ts + listingApi.ts delivery type extensions + ListingWizard delivery options section
- [x] 15-04-PLAN.md — Wave 2b: Buyer offers page inline delivery form + live cost preview + seller offers accept/decline + /api/delivery-distance route
- [x] 15-05-PLAN.md — Wave 3: CarCard delivery badge + search page delivery filter + listing detail sidebar delivery section
- [x] 15-06-PLAN.md — Wave 4: Human verify checkpoint (8 end-to-end flows)
...
| 2. Buyer, Seller, and Dealer Role Dashboards | 4/5 | In Progress|  |

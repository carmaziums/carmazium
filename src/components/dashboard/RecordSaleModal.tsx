    ...
    if (success) {
        return (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                <div className="bg-slate-800 border border-emerald-500/30 rounded-2xl p-8 w-full max-w-md shadow-[0_0_50px_rgba(16,185,129,0.2)] text-center">
                    ...
                    <p className="text-gray-400 text-sm">Revenue tracked and listing updated to SOLD.</p>
                </div>
            </div>
        )
    }
            ...
            <div className="bg-slate-800 border border-white/10 rounded-2xl p-6 w-full max-w-lg shadow-2xl relative">
                ...
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 font-bold uppercase tracking-widest">{listing.title}</p>
                    </div>
                </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="pl-8 bg-white/5 border-white/10 focus:border-primary text-white h-14 text-lg font-black"
                                required
                            />
                        </div>

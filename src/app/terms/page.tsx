...
export default function TermsPage() {
    return (
        <div className="min-h-screen bg-slate-900 pt-32 pb-20 relative">
            ...
            <div className="container mx-auto px-5 max-w-4xl">
                ...
                <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <h1 className="text-4xl md:text-5xl font-heading font-black text-white mb-6 uppercase tracking-tight">Terms & Conditions</h1>
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150">
                    {/* 1. Platform Role */}
                    <section className="bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 p-8 shadow-xl">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0">
                                <span className="font-bold">1</span>
                            </div>
                            <h2 className="text-2xl font-bold text-white uppercase tracking-wide">Platform Role (Important)</h2>
                        </div>
                        <div className="text-gray-300 space-y-3 pl-13">
                    ...
                    <section className="bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 p-8 shadow-xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-2xl font-bold text-white uppercase tracking-wide">Acceptance of Terms</h2>
                        </div>
                        <div className="text-gray-300 space-y-3 pl-13 text-sm leading-relaxed">
                    ...
                    <section className="bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 p-8 shadow-xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-2xl font-bold text-white uppercase tracking-wide">User Responsibilities</h2>
                        </div>
                        <div className="text-gray-300 space-y-4 pl-13 text-sm">
                            ...
                            <p className="font-bold mt-4 text-white">You must ensure that:</p>
                            <ul className="list-disc pl-5 space-y-2">
                    ...
                    <section className="bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 p-8 shadow-xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-2xl font-bold text-white uppercase tracking-wide">Content & Data Rights</h2>
                        </div>
                        <div className="text-gray-300 space-y-3 pl-13 text-sm leading-relaxed">
                    ...
                    <section className="bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 p-8 shadow-xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-2xl font-bold text-white uppercase tracking-wide">Buying & Offers Policy</h2>
                        </div>
                        <div className="text-gray-300 space-y-3 pl-13 text-sm leading-relaxed">
                    ...
                    <section className="bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 p-8 shadow-xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-2xl font-bold text-white uppercase tracking-wide">Selling & Auction Rules</h2>
                        </div>
                        <div className="text-gray-300 space-y-3 pl-13 text-sm leading-relaxed">
                            <ul className="list-disc pl-5 space-y-2">
                            ...
                            <p className="mt-4 text-white font-bold">Important Rules:</p>
                            <ul className="list-disc pl-5 space-y-2">
                    ...
                    <section className="bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 p-8 shadow-xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-2xl font-bold text-white uppercase tracking-wide">Inspection & Payment Rules</h2>
                        </div>
                        <div className="text-gray-300 space-y-3 pl-13 text-sm leading-relaxed">
                    ...
                    <section className="bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 p-8 shadow-xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-2xl font-bold text-white uppercase tracking-wide">Liability & No Guarantees</h2>
                        </div>
                        <div className="text-gray-300 space-y-3 pl-13 text-sm leading-relaxed">
                    ...
                    <section className="bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 p-8 shadow-xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-2xl font-bold text-white uppercase tracking-wide">Prohibited Use</h2>
                        </div>
                        <div className="text-gray-300 space-y-3 pl-13 text-sm leading-relaxed">
                            <p>You must NOT:</p>
                            <ul className="list-disc pl-5 space-y-2">
                    ...
                    <section className="bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 p-8 shadow-xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-2xl font-bold text-white uppercase tracking-wide">Legal Jurisdiction & Age Limit</h2>
                        </div>
                        <div className="text-gray-300 space-y-3 pl-13 text-sm leading-relaxed">

...
export const metadata: Metadata = {
    ...
    description: "Learn how CarMazium auctions work for sellers and verified trade dealers, including bidding, the winning buyer fee and vehicle handover.",
    alternates: { canonical: "/auctions/how-it-works" },
    openGraph: {
        title: "How CarMazium Vehicle Auctions Work | CarMazium",
        description: "Learn how CarMazium auctions work for sellers and verified trade dealers.",

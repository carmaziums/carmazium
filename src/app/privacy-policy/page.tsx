  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>When you send a message to MaziuM AI, the prompt and recent conversation context needed to answer it are sent to OpenAI for processing. The website and native apps ask you to acknowledge this before the first prompt is sent. Do not include unnecessary sensitive personal information, passwords, payment credentials or authentication codes in AI prompts.</p>
        <p>If you use the in-app “Report AI response” feature, CarMazium stores the reported AI response, the associated prompt where available, your selected reason and any optional details so an administrator can review the report and improve safety controls.</p>

  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>When you send a message to MaziuM AI, the prompt and recent conversation context needed to answer it are sent to OpenAI for processing. Do not include unnecessary sensitive personal information in AI prompts.</p>

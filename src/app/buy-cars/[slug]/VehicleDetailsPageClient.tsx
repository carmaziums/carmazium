                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {listing.exteriorGrade && <div className="flex justify-between"><span className="text-[var(--text-muted)] text-sm">Exterior grade:</span><span className="text-[var(--text-primary)] font-semibold text-sm">Grade {listing.exteriorGrade} of 5</span></div>}

    ...
    return (
        <div className="min-h-screen pt-24 pb-20">
            <main className="container mx-auto px-5 max-w-6xl">
                <Link href="/auctions" className="inline-flex items-center gap-2 text-sm text-[var(--text-muted)] hover:text-primary mb-6"><ArrowLeft size={15} /> Back to Trade Exchange</Link>
                ...
                <section className="grid lg:grid-cols-[0.8fr_1.2fr] gap-10 items-start mb-16">
                    <aside className="lg:sticky lg:top-24">
                        <div className="inline-flex items-center gap-2 rounded-full border border-amber-500/25 bg-amber-500/10 px-4 py-1.5 mb-5 text-xs font-bold uppercase tracking-widest text-amber-500">
                            <Building2 size={13} /> Trade Exchange · Vehicle Finance
                        </div>
                ...
                <section className="rounded-3xl border border-amber-500/25 bg-amber-500/5 p-8 md:p-10">
                    <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                        <div>
                            ...
                            <h2 className="text-3xl font-black font-heading mb-4">Receive matched vehicle-finance enquiries through Trade Exchange</h2>
                        ...
                        <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
                            ...
                            <div className="flex gap-3 rounded-xl border border-[var(--border-default)] bg-[var(--bg-input)] p-5"><LayoutDashboard className="text-primary shrink-0" /><div><h3 className="font-bold text-sm mb-1">Dedicated enquiry inbox</h3><p className="text-xs text-[var(--text-muted)]">Review and manage Trade Exchange finance enquiries from your provider dashboard.</p></div></div>
                        </div>
                    </div>
                </section>
            </main>

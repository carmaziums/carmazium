            ...
            <div className="container mx-auto px-5 flex flex-col lg:flex-row gap-8">
                ...
                <main className="flex-1 space-y-6 min-w-0">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            <h1 className="text-3xl font-black font-heading uppercase tracking-tighter metallic-foil">Offers</h1>
                            <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mt-1 opacity-70">Direct high-value vehicle acquisition review</p>
                        </div>
                        <div className="flex items-center gap-3 bg-[#0A0A0C] px-4 py-2 rounded-full border border-white/5">
                            <ShieldCheck size={14} className="text-amber-400" />
                            <span className="text-[10px] font-black uppercase tracking-widest text-gray-300">Secure Terminal Active</span>
                        </div>
                    </div>
